...
| Altcoin Discovery | Find evidence-backed candidates | Implemented for perps: Perp DEX Projects and New Perp Listings with separate filters, evidence panels, risk flags, lifecycle alerts and declared coverage; Emerging Projects, general spot launches and historical outcomes remain planned |
...
- [ ] Stages 5–6: deliver the remaining interfaces and research tools in the sequence above, subject to the recorded feed gates.
