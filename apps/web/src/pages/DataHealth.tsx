...
type Series={id:string;asset_id:string;metric_code:string;source_id:string;state:string;last_success_at:string|null;last_observation_at:string|null;interval_seconds:number;detected_interval_seconds:number|null;irregular_intervals:number;missing_intervals:number;resolved_gaps:number;maximum_detection_latency_seconds:number|null;replay_coverage_start:string|null};
